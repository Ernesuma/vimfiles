...
" Colours {{{1
"" General {{{2
hi Normal       ctermfg=255 guifg=#eeeeee ctermbg=0   guibg=#000000 cterm=none gui=none
...
hi ColorColumn                            ctermbg=234 guibg=#1c1c1c cterm=NONE gui=NONE
" TODO
" hi MoreMsg
...
hi Identifier   ctermfg=177 guifg=#d787ff                           cterm=none
hi Ignore       ctermfg=238 guifg=#444444
hi Number       ctermfg=214 guifg=#ffaf00
hi PreProc      ctermfg=148 guifg=#afd700
hi Special      ctermfg=174 guifg=#df8787
hi Statement    ctermfg=111 guifg=#87afff                           cterm=none gui=none
...
""" vimdiff {{{3
hi diffAdd      ctermfg=bg  guifg=bg   ctermbg=150 guibg=#afdfaf
